package org.evolution.oplus.DeviceExtras.touch;
...
public class ActionUtils {
    ...
    private static Intent getDeviceExtrasIntent(Context context) {
        Intent intent = new Intent();
        ComponentName cn=new ComponentName("org.evolution.oplus.DeviceExtras",
                "org.evolution.oplus.DeviceExtras.DeviceExtrasActivity");
        intent.setComponent(cn);
        return intent;
    }
    ...
    public static void triggerAction(Context context, int action) {
        ...
        if (km.isKeyguardLocked()) {
            intent = new Intent();
            intent.setClassName("org.evolution.oplus.DeviceExtras", "org.evolution.oplus.DeviceExtras.touch.ScreenOffLaunchGestureActivity");
